...
| <img src="https://upload.wikimedia.org/wikipedia/commons/a/a0/Firefox_logo%2C_2019.svg" height="24"> | **[Firefox Add-ons](https://addons.mozilla.org/en-US/firefox/addon/noai-remove-ai-clutter/)** | 🎉 Now Live! The extension is now available to install from the Firefox Add-ons store! If you try it, please consider leaving a rating or sharing your feedback. Bug reports, feature requests, and suggestions are always welcome, they help make the extension better for everyone. |
| <img src="https://api.iconify.design/octicon:mark-github-24.svg?color=white" height="24"> | **[GitHub Releases](https://github.com/diluteoxygen/noai/releases)** | 📦 **Available Now!** Download the latest `.zip` [here](https://github.com/diluteoxygen/noai/releases) and load it manually into your browser. |
